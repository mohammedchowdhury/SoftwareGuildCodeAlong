...
for(let a=0; a<winniesFavoriteNumber+kaisFavoriteNumber ; a++){
	if(a === winniesFavoriteNumber || a === kaisFavoriteNumber){
		console.log(a); 
		break; 
	}
